...
CREATE OR REPLACE FUNCTION "integrations"."notify_order_whatsapp"() RETURNS "trigger"
...
DECLARE
  ...
  v_payload TEXT;
BEGIN
  v_url := 'https://moinedjbjuioncemqomf.supabase.co/functions/v1/order-notify';
...
ALTER FUNCTION "integrations"."notify_order_whatsapp"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "integrations"."resend_order_notification"("p_order_id" "uuid", "p_event" "text" DEFAULT 'new_order'::"text") RETURNS "text"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_url    TEXT;
...
ALTER FUNCTION "integrations"."resend_order_notification"("p_order_id" "uuid", "p_event" "text") OWNER TO "postgres";


COMMENT ON FUNCTION "integrations"."resend_order_notification"("p_order_id" "uuid", "p_event" "text") IS 'Reenvia notificação WhatsApp de um pedido. event pode ser: new_order, confirmed, preparing, out_for_delivery, delivered, cancelled';



CREATE OR REPLACE FUNCTION "integrations"."set_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN NEW.updated_at = now(); RETURN NEW; END;
$$;
...
ALTER FUNCTION "integrations"."set_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "catalog"."store_theme" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "primary_color" character varying(7) DEFAULT '#6366F1'::character varying NOT NULL,
    "secondary_color" character varying(7) DEFAULT '#8B5CF6'::character varying NOT NULL,
    ...
    "surface_color" character varying(7) DEFAULT '#F9FAFB'::character varying NOT NULL,
    "text_color" character varying(7) DEFAULT '#111827'::character varying NOT NULL,
    "font_family" character varying(80) DEFAULT 'Inter'::character varying NOT NULL,
    "border_radius" character varying(20) DEFAULT 'rounded'::character varying NOT NULL,
    "card_style" character varying(20) DEFAULT 'shadow'::character varying NOT NULL,
    "header_style" character varying(20) DEFAULT 'cover'::character varying NOT NULL,
...
ALTER TABLE "catalog"."store_theme" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "core"."store_hours" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
...
ALTER TABLE "core"."store_hours" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "core"."stores" (
    ...
    "open_manually" boolean DEFAULT false NOT NULL,
    CONSTRAINT "stores_nickname_format" CHECK ((("nickname")::"text" ~ '^[a-z0-9\-]+$'::"text"))
);
...
CREATE TABLE IF NOT EXISTS "integrations"."whatsapp_message_log" (
...
ALTER TABLE "integrations"."whatsapp_message_log" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "integrations"."vw_whatsapp_log" AS
 SELECT "l"."id",
    "l"."created_at",
    "l"."sent_at",
    "l"."event",
   ...
   FROM ((("integrations"."whatsapp_message_log" "l"
     LEFT JOIN "orders"."orders" "o" ON (("o"."id" = "l"."order_id")))
     LEFT JOIN "core"."customers" "c" ON (("c"."id" = "o"."customer_id")))
     LEFT JOIN "core"."stores" "s" ON (("s"."id" = "l"."store_id")))
  ORDER BY "l"."created_at" DESC;


ALTER VIEW "integrations"."vw_whatsapp_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "integrations"."whatsapp_config" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "evolution_url" "text" DEFAULT 'https://evolutionapi.birdra1n.com'::"text",
    "api_key" "text",
    "instance_name" "text" NOT NULL,
    "instance_status" "text" DEFAULT 'disconnected'::"text" NOT NULL,
    "send_on_pending" boolean DEFAULT false NOT NULL,
    "send_on_confirmed" boolean DEFAULT true NOT NULL,
    "send_on_preparing" boolean DEFAULT true NOT NULL,
    "send_on_out_for_delivery" boolean DEFAULT true NOT NULL,
    "send_on_delivered" boolean DEFAULT true NOT NULL,
    "send_on_cancelled" boolean DEFAULT true NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "use_own_server" boolean DEFAULT false NOT NULL
);


ALTER TABLE "integrations"."whatsapp_config" OWNER TO "postgres";


CREATE OR REPLACE VIEW "integrations"."whatsapp_config_safe" WITH ("security_invoker"='false') AS
 SELECT "id",
    "store_id",
    "instance_name",
    "instance_status",
    "use_own_server",
        CASE
            WHEN ("evolution_url" IS NOT NULL) THEN "regexp_replace"("evolution_url", '(?<=.{10}).(?=.*\.)'::"text", '•'::"text", 'g'::"text")
            ELSE NULL::"text"
        END AS "evolution_url_masked",
    (("evolution_url" IS NOT NULL) AND ("evolution_url" <> ''::"text")) AS "has_evolution_url",
    "send_on_pending",
    "send_on_confirmed",
    "send_on_preparing",
    "send_on_out_for_delivery",
    "send_on_delivered",
    "send_on_cancelled",
    "updated_at",
        CASE
            WHEN (("api_key" IS NOT NULL) AND ("length"("api_key") > 4)) THEN ("repeat"('•'::"text", ("length"("api_key") - 4)) || "right"("api_key", 4))
            ELSE '••••'::"text"
        END AS "api_key_masked",
    (("api_key" IS NOT NULL) AND ("api_key" <> ''::"text")) AS "has_api_key"
   FROM "integrations"."whatsapp_config"
  WHERE ("store_id" IN ( SELECT "stores"."id"
           FROM "core"."stores"
          WHERE ("stores"."user_id" = "auth"."uid"())));


ALTER VIEW "integrations"."whatsapp_config_safe" OWNER TO "postgres";
...
ALTER TABLE ONLY "catalog"."store_theme"
    ADD CONSTRAINT "store_theme_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "catalog"."store_theme"
    ADD CONSTRAINT "store_theme_store_id_key" UNIQUE ("store_id");
...
ALTER TABLE ONLY "core"."store_hours"
    ADD CONSTRAINT "store_hours_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "core"."store_hours"
    ADD CONSTRAINT "store_hours_store_id_day_of_week_key" UNIQUE ("store_id", "day_of_week");



ALTER TABLE ONLY "core"."stores"
    ADD CONSTRAINT "stores_nickname_key" UNIQUE ("nickname");
...
ALTER TABLE ONLY "integrations"."whatsapp_config"
    ADD CONSTRAINT "whatsapp_config_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "integrations"."whatsapp_config"
    ADD CONSTRAINT "whatsapp_config_store_id_key" UNIQUE ("store_id");



ALTER TABLE ONLY "integrations"."whatsapp_message_log"
...
CREATE OR REPLACE TRIGGER "trg_store_theme_updated_at" BEFORE UPDATE ON "catalog"."store_theme" FOR EACH ROW EXECUTE FUNCTION "core"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_store_hours_updated_at" BEFORE UPDATE ON "core"."store_hours" FOR EACH ROW EXECUTE FUNCTION "core"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_whatsapp_config_updated_at" BEFORE UPDATE ON "integrations"."whatsapp_config" FOR EACH ROW EXECUTE FUNCTION "integrations"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_order_whatsapp_notify" AFTER INSERT OR UPDATE OF "status" ON "orders"."orders" FOR EACH ROW EXECUTE FUNCTION "integrations"."notify_order_whatsapp"();
...
ALTER TABLE ONLY "catalog"."store_theme"
    ADD CONSTRAINT "store_theme_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "core"."store_hours"
    ADD CONSTRAINT "store_hours_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "integrations"."whatsapp_config"
    ADD CONSTRAINT "whatsapp_config_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "integrations"."whatsapp_message_log"
    ADD CONSTRAINT "whatsapp_message_log_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "orders"."orders"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "integrations"."whatsapp_message_log"
    ADD CONSTRAINT "whatsapp_message_log_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;
...
CREATE POLICY "owner_all_store_theme" ON "catalog"."store_theme" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "public_read_store_theme" ON "catalog"."store_theme" FOR SELECT USING (true);
...
CREATE POLICY "owner_all_store_hours" ON "core"."store_hours" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "public_read_store_hours" ON "core"."store_hours" FOR SELECT USING (true);



CREATE POLICY "public_read_stores" ON "core"."stores" FOR SELECT USING (true);
...
CREATE POLICY "owner_whatsapp_config_safe" ON "integrations"."whatsapp_config" FOR SELECT TO "authenticated" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "store_owner_config" ON "integrations"."whatsapp_config" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "store_owner_log" ON "integrations"."whatsapp_message_log" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



ALTER TABLE "integrations"."whatsapp_config" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "integrations"."whatsapp_message_log" ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "catalog"."addon_groups" TO "authenticated";
GRANT SELECT ON TABLE "catalog"."addon_groups" TO "anon";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "catalog"."addons" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "catalog"."product_images" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "catalog"."store_theme" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."delivery_drivers" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."delivery_drivers" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."delivery_zones" TO "authenticated";
GRANT SELECT ON TABLE "core"."delivery_zones" TO "anon";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."delivery_zones" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."store_hours" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."store_hours" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."stores" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "core"."stores" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "finance"."daily_summaries" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "integrations"."whatsapp_message_log" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."orders" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."orders" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "integrations"."vw_whatsapp_log" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "integrations"."whatsapp_config" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "integrations"."whatsapp_config_safe" TO "service_role";
GRANT SELECT ON TABLE "integrations"."whatsapp_config_safe" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "inventory"."product_supplies" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "inventory"."stock_movements" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "inventory"."supplies" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "inventory"."vw_low_stock_alerts" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."order_item_addons" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."order_item_addons" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."order_items" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."order_items" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "orders"."orders_order_number_seq" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."vw_order_summary" TO "authenticated";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "orders"."vw_order_summary" TO "service_role";
...
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "catalog" GRANT SELECT,USAGE ON SEQUENCES TO "authenticated";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "catalog" GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO "authenticated";
...
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "finance" GRANT SELECT,USAGE ON SEQUENCES TO "authenticated";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "finance" GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO "authenticated";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "integrations" GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO "service_role";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "inventory" GRANT SELECT,USAGE ON SEQUENCES TO "authenticated";
...
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "orders" GRANT SELECT,USAGE ON SEQUENCES TO "authenticated";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "orders" GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO "authenticated";
ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "orders" GRANT SELECT,INSERT,DELETE,UPDATE ON TABLES TO "service_role";
