...
ALTER TYPE "inventory"."movement_type" OWNER TO "postgres";


CREATE TYPE "inventory"."unit_of_measure" AS ENUM (
    'unit',
    'kg',
    'g',
    'liter',
...
ALTER TYPE "inventory"."unit_of_measure" OWNER TO "postgres";
...
ALTER TYPE "orders"."order_status" OWNER TO "postgres";


CREATE TYPE "orders"."order_type" AS ENUM (
    'delivery',
    'pickup',
    'table'
);
...
ALTER TYPE "orders"."order_type" OWNER TO "postgres";
...
ALTER TYPE "orders"."payment_method" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "catalog"."fn_set_single_primary_image"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "catalog"."fn_set_single_primary_image"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "core"."fn_set_customer_location"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "core"."fn_set_customer_location"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "core"."fn_set_store_location"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF NEW.latitude IS NOT NULL AND NEW.longitude IS NOT NULL THEN
...
ALTER FUNCTION "core"."fn_set_store_location"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "orders"."fn_deduct_stock_on_confirm"() RETURNS "trigger"
...
BEGIN
  IF NEW.status = 'confirmed' AND OLD.status != 'confirmed' THEN
    ...
    LOOP
      FOR v_supply IN
        SELECT ps.supply_id, ps.quantity_used, s.unit_cost
        FROM inventory.product_supplies ps
        JOIN inventory.supplies s ON s.id = ps.supply_id
        WHERE ps.product_id = v_item.product_id
      LOOP
        INSERT INTO inventory.stock_movements (
          store_id, supply_id, order_id, type, quantity, unit_cost, notes
        ) VALUES (
          NEW.store_id,
          v_supply.supply_id,
          NEW.id,
          'order',
          -(v_supply.quantity_used * v_item.quantity),
          v_supply.unit_cost,
          'Auto deduction — Order #' || NEW.order_number
        );

        UPDATE inventory.supplies
        SET current_quantity = current_quantity - (v_supply.quantity_used * v_item.quantity)
...
ALTER FUNCTION "orders"."fn_deduct_stock_on_confirm"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "orders"."fn_set_delivery_location"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "orders"."fn_set_delivery_location"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_updated_at_trigger"("schema_name" "text", "table_name" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  EXECUTE format(
...
ALTER FUNCTION "public"."create_updated_at_trigger"("schema_name" "text", "table_name" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "catalog"."addon_groups" (
...
ALTER TABLE "catalog"."addon_groups" OWNER TO "postgres";
...
ALTER TABLE "catalog"."addons" OWNER TO "postgres";
...
ALTER TABLE "catalog"."product_images" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "core"."delivery_drivers" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "name" character varying(255) NOT NULL,
    "phone" character varying(20),
...
ALTER TABLE "core"."delivery_drivers" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "core"."delivery_zones" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "neighborhood" character varying(150) NOT NULL,
...
ALTER TABLE "core"."delivery_zones" OWNER TO "postgres";
...
COMMENT ON COLUMN "core"."stores"."latitude" IS 'Latitude GPS da loja — opcional.';



COMMENT ON COLUMN "core"."stores"."longitude" IS 'Longitude GPS da loja — opcional.';



COMMENT ON COLUMN "core"."stores"."location" IS 'Ponto geográfico PostGIS gerado automaticamente a partir de lat/lng.';



CREATE TABLE IF NOT EXISTS "finance"."daily_summaries" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "date" "date" NOT NULL,
...
ALTER TABLE "finance"."daily_summaries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "inventory"."product_supplies" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "product_id" "uuid" NOT NULL,
    "supply_id" "uuid" NOT NULL,
    "quantity_used" numeric(10,4) DEFAULT 1 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "inventory"."product_supplies" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "inventory"."supplies" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "store_id" "uuid" NOT NULL,
    "name" character varying(255) NOT NULL,
    "description" "text",
    "unit" "inventory"."unit_of_measure" DEFAULT 'unit'::"inventory"."unit_of_measure" NOT NULL,
    "unit_cost" numeric(10,4) DEFAULT 0 NOT NULL,
    "current_quantity" numeric(10,4) DEFAULT 0 NOT NULL,
    "minimum_quantity" numeric(10,4) DEFAULT 0 NOT NULL,
    "active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
CREATE OR REPLACE VIEW "inventory"."vw_low_stock_alerts" AS
 SELECT "id",
    "store_id",
    "name",
    "unit",
    ...
    "minimum_quantity",
    "unit_cost",
    ("current_quantity" <= "minimum_quantity") AS "below_minimum",
    ("current_quantity" * "unit_cost") AS "stock_value"
   FROM "inventory"."supplies" "s"
  WHERE ("active" = true)
  ORDER BY ("current_quantity" <= "minimum_quantity") DESC, "name";


ALTER VIEW "inventory"."vw_low_stock_alerts" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "orders"."order_item_addons" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE "orders"."order_item_addons" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "orders"."orders" (
    ...
    "type" "orders"."order_type" DEFAULT 'delivery'::"orders"."order_type" NOT NULL,
    "status" "orders"."order_status" DEFAULT 'pending'::"orders"."order_status" NOT NULL,
    "payment_method" "orders"."payment_method" NOT NULL,
    "change_for" numeric(10,2),
    "delivery_address" "text",
    "delivery_complement" "text",
    "delivery_neighborhood" character varying(100),
    ...
    "delivery_neighborhood_snapshot" character varying(150),
...
COMMENT ON COLUMN "orders"."orders"."delivery_fee" IS 'Taxa snapshot no momento do pedido, originada de core.delivery_zones.delivery_fee';



COMMENT ON COLUMN "orders"."orders"."delivery_zone_id" IS 'Zona de entrega selecionada pelo cliente. SET NULL se a zona for removida posteriormente.';



COMMENT ON COLUMN "orders"."orders"."delivery_neighborhood_snapshot" IS 'Snapshot do bairro no momento do pedido para preservar histórico.';



COMMENT ON COLUMN "orders"."orders"."delivery_latitude" IS 'Latitude GPS informada pelo cliente no momento do pedido.';



COMMENT ON COLUMN "orders"."orders"."delivery_longitude" IS 'Longitude GPS informada pelo cliente no momento do pedido.';



COMMENT ON COLUMN "orders"."orders"."delivery_location" IS 'Ponto geográfico PostGIS gerado a partir de lat/lng para consultas espaciais.';
...
ALTER SEQUENCE "orders"."orders_order_number_seq" OWNER TO "postgres";


ALTER SEQUENCE "orders"."orders_order_number_seq" OWNED BY "orders"."orders"."order_number";
...
CREATE OR REPLACE VIEW "orders"."vw_order_summary" AS
 SELECT "o"."id",
   ...
   FROM (("orders"."orders" "o"
     ...
     LEFT JOIN "core"."delivery_drivers" "d" ON (("d"."id" = "o"."driver_id")));


ALTER VIEW "orders"."vw_order_summary" OWNER TO "postgres";


ALTER TABLE ONLY "orders"."orders" ALTER COLUMN "order_number" SET DEFAULT "nextval"('"orders"."orders_order_number_seq"'::"regclass");



ALTER TABLE ONLY "catalog"."addon_groups"
    ADD CONSTRAINT "addon_groups_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "catalog"."addons"
...
ALTER TABLE ONLY "core"."delivery_drivers"
    ADD CONSTRAINT "delivery_drivers_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "core"."delivery_zones"
    ADD CONSTRAINT "delivery_zones_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "core"."delivery_zones"
    ADD CONSTRAINT "delivery_zones_store_id_neighborhood_city_key" UNIQUE ("store_id", "neighborhood", "city");
...
ALTER TABLE ONLY "finance"."daily_summaries"
    ADD CONSTRAINT "daily_summaries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "finance"."daily_summaries"
    ADD CONSTRAINT "daily_summaries_store_id_date_key" UNIQUE ("store_id", "date");



ALTER TABLE ONLY "inventory"."product_supplies"
    ADD CONSTRAINT "product_supplies_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "inventory"."product_supplies"
    ADD CONSTRAINT "product_supplies_product_id_supply_id_key" UNIQUE ("product_id", "supply_id");
...
ALTER TABLE ONLY "orders"."order_item_addons"
...
CREATE INDEX "idx_addon_groups_product_id" ON "catalog"."addon_groups" USING "btree" ("product_id");



CREATE INDEX "idx_addons_group_id" ON "catalog"."addons" USING "btree" ("group_id");



CREATE INDEX "idx_categories_store_id" ON "catalog"."categories" USING "btree" ("store_id");



CREATE UNIQUE INDEX "idx_product_images_primary" ON "catalog"."product_images" USING "btree" ("product_id") WHERE ("is_primary" = true);



CREATE INDEX "idx_product_images_product_id" ON "catalog"."product_images" USING "btree" ("product_id");



CREATE INDEX "idx_products_category_id" ON "catalog"."products" USING "btree" ("category_id");



CREATE INDEX "idx_products_store_id" ON "catalog"."products" USING "btree" ("store_id");



CREATE INDEX "idx_customers_location" ON "core"."customers" USING "gist" ("location");



CREATE INDEX "idx_customers_store_id" ON "core"."customers" USING "btree" ("store_id");



CREATE INDEX "idx_delivery_drivers_store_id" ON "core"."delivery_drivers" USING "btree" ("store_id");



CREATE INDEX "idx_delivery_zones_active" ON "core"."delivery_zones" USING "btree" ("store_id", "active");



CREATE INDEX "idx_delivery_zones_store_id" ON "core"."delivery_zones" USING "btree" ("store_id");



CREATE INDEX "idx_stores_location" ON "core"."stores" USING "gist" ("location");



CREATE INDEX "idx_daily_summaries_store_date" ON "finance"."daily_summaries" USING "btree" ("store_id", "date");



CREATE INDEX "idx_product_supplies_product_id" ON "inventory"."product_supplies" USING "btree" ("product_id");



CREATE INDEX "idx_product_supplies_supply_id" ON "inventory"."product_supplies" USING "btree" ("supply_id");



CREATE INDEX "idx_stock_movements_order_id" ON "inventory"."stock_movements" USING "btree" ("order_id");



CREATE INDEX "idx_stock_movements_store_id" ON "inventory"."stock_movements" USING "btree" ("store_id");



CREATE INDEX "idx_stock_movements_supply_id" ON "inventory"."stock_movements" USING "btree" ("supply_id");



CREATE INDEX "idx_supplies_store_id" ON "inventory"."supplies" USING "btree" ("store_id");



CREATE INDEX "idx_order_item_addons_item_id" ON "orders"."order_item_addons" USING "btree" ("order_item_id");
...
CREATE INDEX "idx_orders_customer_id" ON "orders"."orders" USING "btree" ("customer_id");
...
CREATE INDEX "idx_orders_delivery_zone_id" ON "orders"."orders" USING "btree" ("delivery_zone_id");
...
CREATE INDEX "idx_orders_store_id" ON "orders"."orders" USING "btree" ("store_id");



CREATE OR REPLACE TRIGGER "trg_addon_groups_updated_at" BEFORE UPDATE ON "catalog"."addon_groups" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_addons_updated_at" BEFORE UPDATE ON "catalog"."addons" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_categories_updated_at" BEFORE UPDATE ON "catalog"."categories" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_product_images_updated_at" BEFORE UPDATE ON "catalog"."product_images" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_products_updated_at" BEFORE UPDATE ON "catalog"."products" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_single_primary_image" BEFORE INSERT OR UPDATE OF "is_primary" ON "catalog"."product_images" FOR EACH ROW EXECUTE FUNCTION "catalog"."fn_set_single_primary_image"();



CREATE OR REPLACE TRIGGER "trg_customers_updated_at" BEFORE UPDATE ON "core"."customers" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_delivery_drivers_updated_at" BEFORE UPDATE ON "core"."delivery_drivers" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_delivery_zones_updated_at" BEFORE UPDATE ON "core"."delivery_zones" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_set_customer_location" BEFORE INSERT OR UPDATE OF "latitude", "longitude" ON "core"."customers" FOR EACH ROW EXECUTE FUNCTION "core"."fn_set_customer_location"();



CREATE OR REPLACE TRIGGER "trg_set_store_location" BEFORE INSERT OR UPDATE OF "latitude", "longitude" ON "core"."stores" FOR EACH ROW EXECUTE FUNCTION "core"."fn_set_store_location"();



CREATE OR REPLACE TRIGGER "trg_stores_updated_at" BEFORE UPDATE ON "core"."stores" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_daily_summaries_updated_at" BEFORE UPDATE ON "finance"."daily_summaries" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_supplies_updated_at" BEFORE UPDATE ON "inventory"."supplies" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_deduct_stock_on_confirm" AFTER UPDATE OF "status" ON "orders"."orders" FOR EACH ROW EXECUTE FUNCTION "orders"."fn_deduct_stock_on_confirm"();



CREATE OR REPLACE TRIGGER "trg_orders_updated_at" BEFORE UPDATE ON "orders"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "trg_set_delivery_location" BEFORE INSERT OR UPDATE OF "delivery_latitude", "delivery_longitude" ON "orders"."orders" FOR EACH ROW EXECUTE FUNCTION "orders"."fn_set_delivery_location"();



ALTER TABLE ONLY "catalog"."addon_groups"
    ADD CONSTRAINT "addon_groups_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "catalog"."products"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "catalog"."addons"
    ADD CONSTRAINT "addons_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "catalog"."addon_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "catalog"."categories"
    ADD CONSTRAINT "categories_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "catalog"."products"
    ADD CONSTRAINT "products_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "catalog"."categories"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "catalog"."products"
    ADD CONSTRAINT "products_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "core"."customers"
    ADD CONSTRAINT "customers_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "core"."delivery_drivers"
    ADD CONSTRAINT "delivery_drivers_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "core"."delivery_zones"
    ADD CONSTRAINT "delivery_zones_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "finance"."daily_summaries"
    ADD CONSTRAINT "daily_summaries_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "inventory"."product_supplies"
    ADD CONSTRAINT "product_supplies_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "catalog"."products"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "inventory"."product_supplies"
    ADD CONSTRAINT "product_supplies_supply_id_fkey" FOREIGN KEY ("supply_id") REFERENCES "inventory"."supplies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "inventory"."stock_movements"
    ADD CONSTRAINT "stock_movements_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "orders"."orders"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "inventory"."stock_movements"
    ADD CONSTRAINT "stock_movements_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "inventory"."stock_movements"
    ADD CONSTRAINT "stock_movements_supply_id_fkey" FOREIGN KEY ("supply_id") REFERENCES "inventory"."supplies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "inventory"."supplies"
    ADD CONSTRAINT "supplies_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "orders"."order_item_addons"
    ADD CONSTRAINT "order_item_addons_addon_id_fkey" FOREIGN KEY ("addon_id") REFERENCES "catalog"."addons"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "orders"."order_item_addons"
    ADD CONSTRAINT "order_item_addons_order_item_id_fkey" FOREIGN KEY ("order_item_id") REFERENCES "orders"."order_items"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "orders"."order_items"
    ADD CONSTRAINT "order_items_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "catalog"."products"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "orders"."orders"
    ADD CONSTRAINT "orders_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "core"."customers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "orders"."orders"
    ADD CONSTRAINT "orders_delivery_zone_id_fkey" FOREIGN KEY ("delivery_zone_id") REFERENCES "core"."delivery_zones"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "orders"."orders"
    ADD CONSTRAINT "orders_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "core"."delivery_drivers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "orders"."orders"
    ADD CONSTRAINT "orders_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "core"."stores"("id") ON DELETE CASCADE;



ALTER TABLE "catalog"."addon_groups" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "owner_addon_groups" ON "catalog"."addon_groups" USING (("product_id" IN ( SELECT "products"."id"
...
CREATE POLICY "owner_addons" ON "catalog"."addons" USING (("group_id" IN ( SELECT "addon_groups"."id"
   FROM "catalog"."addon_groups"
  WHERE ("addon_groups"."product_id" IN ( SELECT "products"."id"
           FROM "catalog"."products"
          WHERE ("products"."store_id" IN ( SELECT "stores"."id"
                   FROM "core"."stores"
                  WHERE ("stores"."user_id" = "auth"."uid"()))))))));
...
CREATE POLICY "owner_categories" ON "catalog"."categories" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_product_images" ON "catalog"."product_images" USING (("product_id" IN ( SELECT "products"."id"
   FROM "catalog"."products"
  WHERE ("products"."store_id" IN ( SELECT "stores"."id"
           FROM "core"."stores"
          WHERE ("stores"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "owner_products" ON "catalog"."products" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));
...
ALTER TABLE "core"."delivery_drivers" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "core"."delivery_zones" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "owner_customers" ON "core"."customers" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_delivery_drivers" ON "core"."delivery_drivers" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_delivery_zones" ON "core"."delivery_zones" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_stores" ON "core"."stores" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "public_read_active_delivery_zones" ON "core"."delivery_zones" FOR SELECT USING (("active" = true));
...
ALTER TABLE "finance"."daily_summaries" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "owner_daily_summaries" ON "finance"."daily_summaries" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_product_supplies" ON "inventory"."product_supplies" USING (("product_id" IN ( SELECT "products"."id"
   FROM "catalog"."products"
  WHERE ("products"."store_id" IN ( SELECT "stores"."id"
           FROM "core"."stores"
          WHERE ("stores"."user_id" = "auth"."uid"()))))));
...
CREATE POLICY "owner_stock_movements" ON "inventory"."stock_movements" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



CREATE POLICY "owner_supplies" ON "inventory"."supplies" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));



ALTER TABLE "inventory"."product_supplies" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "inventory"."stock_movements" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "inventory"."supplies" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "orders"."order_item_addons" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "owner_order_item_addons" ON "orders"."order_item_addons" USING (("order_item_id" IN ( SELECT "oi"."id"
   FROM ("orders"."order_items" "oi"
     JOIN "orders"."orders" "o" ON (("o"."id" = "oi"."order_id")))
  WHERE ("o"."store_id" IN ( SELECT "stores"."id"
           FROM "core"."stores"
          WHERE ("stores"."user_id" = "auth"."uid"()))))));



CREATE POLICY "owner_order_items" ON "orders"."order_items" USING (("order_id" IN ( SELECT "orders"."id"
   FROM "orders"."orders"
...
CREATE POLICY "owner_orders" ON "orders"."orders" USING (("store_id" IN ( SELECT "stores"."id"
   FROM "core"."stores"
  WHERE ("stores"."user_id" = "auth"."uid"()))));
...
GRANT ALL ON FUNCTION "public"."create_updated_at_trigger"("schema_name" "text", "table_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_updated_at_trigger"("schema_name" "text", "table_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_updated_at_trigger"("schema_name" "text", "table_name" "text") TO "service_role";
...
drop extension if exists "pg_net";
  ...
  for all
  to authenticated
using (((bucket_id = 'product-images'::text) AND ((storage.foldername(name))[2] = ( SELECT (stores.id)::text AS id
   FROM core.stores
  WHERE (stores.user_id = auth.uid())
 LIMIT 1))));
  ...
  for insert
  to authenticated
with check (((bucket_id = 'product-images'::text) AND ((storage.foldername(name))[1] = 'stores'::text) AND ((storage.foldername(name))[2] = ( SELECT (stores.id)::text AS id
   FROM core.stores
  WHERE (stores.user_id = auth.uid())
 LIMIT 1))));
